    ...
    <Stack>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1.2rem' }}>
            <div className="hpc-card" style={{ padding: '1.2rem' }}>
              ...
              <p style={{ margin: 0, fontSize: '0.8rem', color: '#cbd5e1', lineHeight: 1.35 }}>
                Reordena operaciones independientes para saturar puertos de ejecución paralelos y mitigar dependencias.
              </p>
            </div>
            ...
            <div className="hpc-card" style={{ padding: '1.2rem' }}>
              ...
              <p style={{ margin: 0, fontSize: '0.8rem', color: '#cbd5e1', lineHeight: 1.35 }}>
                Mantiene variables en registros ultra rápidos (ZMM de 512 bits) evitando derrames a RAM (Spilling).
              </p>
            </div>
            ...
            <div className="hpc-card" style={{ padding: '1.2rem' }}>
              ...
              <p style={{ margin: 0, fontSize: '0.8rem', color: '#cbd5e1', lineHeight: 1.35 }}>
                Auto-vectorización SIMD, desenrollado de bucles (Unrolling) y eliminación de alias con <code>__restrict__</code>.
              </p>
            </div>
          </div>
        </div>
      ...
      <Slide>
        <div style={{ textAlign: 'left', padding: '0.8rem 1.5rem' }}>
          ...
          <h2 style={{ fontSize: '2.1rem', marginBottom: '1rem' }}>Dead Code Optimization (DCO / DCE)</h2>

          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
            <div className="hpc-card" style={{ padding: '1.4rem' }}>
              <h3 style={{ margin: 0, fontSize: '1.15rem', color: '#ffffff' }}>Análisis de Flujo de Datos</h3>
              <p style={{ margin: '0.4rem 0 0 0', fontSize: '0.88rem', color: '#cbd5e1', lineHeight: 1.5 }}>
                El compilador analiza el grafo de dependencias. Si un cálculo no altera el valor de retorno ni genera efectos observables, <strong>se suprime por completo en el binario final</strong>.
              </p>
            </div>
            ...
            <div className="hpc-card" style={{ padding: '1.4rem', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
              ...
              <p style={{ margin: '0.4rem 0 0 0', fontSize: '0.88rem', color: '#cbd5e1', lineHeight: 1.45 }}>
                Reduce drásticamente el número de instrucciones ejecutadas (N_inst) y libera registros físicos para cálculos que sí importan.
              </p>
            </div>
          </div>
        </div>
        ...
        <div style={{ textAlign: 'left', padding: '0.8rem 1.5rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
            <div className="hpc-card" style={{ padding: '1.4rem' }}>
              ...
              <p style={{ margin: '0.4rem 0 0 0', fontSize: '0.88rem', color: '#cbd5e1', lineHeight: 1.5 }}>
                Con <code>-O3 -march=native -ffast-math</code>, el compilador emite instrucciones vectoriales <code>vfmadd231ps</code> en registros ZMM de 512 bits.
              </p>
            </div>
            ...
            <div className="hpc-card" style={{ padding: '1.4rem' }}>
              ...
              <p style={{ margin: '0.4rem 0 0 0', fontSize: '0.88rem', color: '#cbd5e1', lineHeight: 1.5 }}>
                Garantiza que los punteros no solapan regiones de memoria (evita Pointer Aliasing), permitiendo vectorizar de inmediato sin comprobaciones de solapamiento.
              </p>
            </div>
          </div>
        </div>
